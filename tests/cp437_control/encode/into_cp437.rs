...
use codepage_437::{CP437_CONTROL, Cp437Error, IntoCp437};
...
fn good() {
    ...
    assert_eq!(everything_utf8.into_cp437(&CP437_CONTROL), Ok(everything_cp437));
}

#[test]
fn unrepresentable() {
    let err = "Jurek je żurek w żupanie.".to_string().into_cp437(&CP437_CONTROL).unwrap_err();
