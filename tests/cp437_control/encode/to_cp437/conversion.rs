...
fn good() {
    ...
    assert_eq!(everything_utf8.to_cp437(&CP437_CONTROL), Ok(everything_cp437[..].into()));
    assert_eq!(everything_utf8[..].to_cp437(&CP437_CONTROL), Ok(everything_cp437[..].into()));
}

#[test]
fn unrepresentable() {
    assert_eq!("Jurek je żurek w żupanie.".to_cp437(&CP437_CONTROL), Err(Cp437Error { representable_up_to: 9 }));
}
