...
//! let in_unicode = Cow::borrow_from_cp437(data);
//! # assert_eq!(in_unicode, "Local news");
//!
//! // Also valid:
//! let in_unicode = String::borrow_from_cp437(data);
//! # assert_eq!(in_unicode, "Local news");
//! ```
//!
...
//! let in_unicode = String::from_cp437(data);
//! # assert_eq!(in_unicode, "Local news");
//! ```
//!
